                ...
                Maplet borderMaplet = new Maplet()
                {
                    ...
                    MapletContents = new List<MapletContents>() 
                    {
                        new MapletContentsMaplet()
                        {
                            ...
                            Maplet = district.District.Level == 1 ? parser.ParseMaplet(MapletDatabaseHandler.GetMapletByTagAndLevel("Barracks",3)) : parser.ParseMaplet(MapletDatabaseHandler.GetMapletByTagAndLevel("General Store",1)),
                            MaxAmount = 1
                        }
                    }
